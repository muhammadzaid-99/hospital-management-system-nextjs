...
import { registerPatient, createUserProfile, emailLogin, registerDoctor, registerStaff } from "@/lib/actions/user.actions"
...
export function StaffRegisterForm({ profileData }: { profileData: profileDataInterface }) {
    ...
    async function onSubmit(values: z.infer<typeof profileCreateFormSchema>) {
        ...
        const staffReg = await registerStaff(data)
        if (staffReg)
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="w-full">
                                ...
                                <FormDescription>
                                    Please enter your position as staff.
                                </FormDescription>
                                <FormMessage className="text-pink-600" />
                            </FormItem>
                        )}
