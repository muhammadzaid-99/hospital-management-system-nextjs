...
export const DateTimePickerLingua = forwardRef<HTMLInputElement, DateTimePickerProps>(
  ({ dateTime, setDateTime, ...props }, ref) => {
    ...
    return (
      <div className="relative">
        <div className="relative">
          <Input
            placeholder="Try tomorrow at 10am"
            {...props}
            ref={inputRef}
            type="text"
            value={inputValue}
...
DateTimePickerLingua.displayName = "DateTimePicker"